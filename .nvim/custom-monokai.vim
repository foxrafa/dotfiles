...
call s:h("TabLine",       { "fg": s:grey,  "bg": s:lightgrey })
call s:h("TabLineSel",    { "fg": s:orange,  "bg": s:lightblack})
call s:h("TabLineFill",   { "bg": s:lightgrey })
...
call s:h("jsEndColons",           { "fg": s:white })
call s:h("jsModule",              { "fg": s:aqua })
call s:h("jsPredefinedType",      { "fg": s:aqua })
call s:h("jsImport",              { "fg": s:pink })
call s:h("jsExport",              { "fg": s:pink })
call s:h("jsIdentifier",          { "fg": s:orange, "format": "italic" })
call s:h("jsVariable",            { "fg": s:aqua })
call s:h("jsCastKeyword",         { "fg": s:pink })
call s:h("jsAmbientDeclaration",  { "fg": s:pink })
call s:h("jsTestGlobal",          { "fg": s:pink })
call s:h("jsFuncKeyword",         { "fg": s:aqua })
call s:h("jsFuncTypeArrow",       { "fg": s:aqua })
call s:h("jsFuncType",            { "fg": s:orange, "format": "italic" })
call s:h("jsFuncName",            { "fg": s:green })
call s:h("jsArrowFuncArg",        { "fg": s:orange, "format": "italic" })
call s:h("jsCall",                { "fg": s:orange, "format": "italic" })
call s:h("jsClassKeyword",        { "fg": s:aqua,   "format": "italic" })
call s:h("jsClassName",           { "fg": s:white })
call s:h("jsClassHeritage",       { "fg": s:white })
call s:h("jsInterfaceKeyword",    { "fg": s:aqua,   "format": "italic" })
call s:h("jsInterfaceName",       { "fg": s:white })
call s:h("jsObjectLabel",         { "fg": s:green })
call s:h("jsMember",              { "fg": s:green })
call s:h("jsTypeReference",       { "fg": s:purple, "format": "italic" })
call s:h("jsTypeParameter",       { "fg": s:purple, "format": "italic" })
call s:h("jsOptionalMark",        { "fg": s:pink })
